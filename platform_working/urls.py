...
urlpatterns = [
    ...
    path('users/profile/<int:user_id>/update', views.update_user, name='update_user'),
    ...
    path('users/profile/<int:user_id>/review_create/', views.create_review, name='create_review_on_user'),
    path('users/profile/<int:user_id>/review_create/delete', views.delete_review, name='delete_review_on_user'),
    path('songs/<int:song_id>/review_create/', views.create_review, name='create_review_on_song'),
    path('songs/<int:song_id>/review_create/delete', views.delete_review, name='delete_review_on_song'),
    path('users/profile/<int:user_id>/sub', views.create_sub, name='create_sub_on_user'),
    path('users/profile/<int:user_id>/sub/delete', views.delete_sub, name='delete_sub_on_user'),
    path('groups/<int:group_id>/members/sub', views.create_sub, name='create_sub_on_group'),
    path('groups/<int:group_id>/members/sub/delete', views.delete_sub, name='delete_sub_on_group'),
